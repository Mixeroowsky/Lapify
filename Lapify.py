...
class DatabaseConnecion:
    ...
    def getData(self):
        ...
        data_command = "select  distinct p.id_ok, k.imie, k.nazwisko, k.model_samochodu, k.kategoria, (bramka3-bramka1) as okrazenie " \
                       ...
                       "where w.data_wyscigu=(select min(data_wyscigu) from wyscig) ; "
...
class NowaSesja(Screen):
    ...
    def generujtabele(self):
        ...
        tabela.add_widget(PoleTabeli(bgcolor=get_color_from_hex('#E27814'), text="      Model \nsamochodu", size=(170, 35)))
        ...
        for i in sortowanie:
            ...
            tabela.add_widget(PoleTabeli(bgcolor=get_color_from_hex('#505050'),
                                         color=get_color_from_hex('ffffff'), text=sortowanie[licznik][1], size=(120, 35)))
            tabela.add_widget(PoleTabeli(bgcolor=get_color_from_hex('#505050'),
                                         color=get_color_from_hex('ffffff'), text=sortowanie[licznik][2], size=(150, 35)))
            tabela.add_widget(PoleTabeli(bgcolor=get_color_from_hex('#505050'),
                                         color=get_color_from_hex('ffffff'), text=sortowanie[licznik][3], size=(170, 35)))
            tabela.add_widget(PoleTabeli(bgcolor=get_color_from_hex('#505050'),
                                         color=get_color_from_hex('ffffff'), text=sortowanie[licznik][4], size=(125, 35)))
            tabela.add_widget(PoleTabeli(bgcolor=get_color_from_hex('#505050'),
